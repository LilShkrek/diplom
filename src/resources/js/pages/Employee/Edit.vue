...
const form = useForm({
    ...
    service_number: props.employee.service_number,
});
...
<template>
    ...
    <AuthLayout>
        <template #header>
            <h2 class="text-xl font-semibold text-gray-800">Редактировать сотрудника</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <!-- Фамилия -->
                            <div>
                                <Label for="surname" class="text-black">Фамилия</Label>
                                <Input
                                    id="surname"
                                    type="text"
                                    required
                            ...
                            <!-- Должность -->
                            <div>
                                <Label for="position" class="text-black">Должность</Label>
                                <Input
                                    id="position"
                                    type="text"
                                    required
                            ...
                            <!-- Табельный номер -->
                            <div>
                                <Label for="service_number" class="text-black">Табельный номер</Label>
                                <Input
                                    id="service_number"
                                    type="number"
                                    required
                                    ...
                                    class="mt-1 block w-full text-black"
                                />
                                <InputError :message="form.errors.service_number" />
                            </div>
